...
#ifndef PDF2EPUB_IMG_DEBUG_HPP
#define PDF2EPUB_IMG_DEBUG_HPP
 ...
 *	4: DocumentPage* - if points to DocumentPage object, prints text of every part in that region (default: NULL)
 * */
void showParts(cv::Mat, MatPart, std::string wn = "img", DocumentPage* p = NULL);
 ...
 * */
void showPartAsRect(cv::Mat, MatPart, std::string wn = "img", DocumentPage* p = NULL);

#endif // PDF2EPUB_IMG_DEBUG_HPP
